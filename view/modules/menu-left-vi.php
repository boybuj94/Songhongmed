...
<div class="container">
	<!--<h3 style="padding-top:20px;margin:auto;width:auto;text-align:center;border-bottom:none;">SẢN PHẨM</h3>-->
		<ul class="accordion">
				...
				?>
			      <li>
			        <a href="products/nhom-san-pham/<?php echo $rows['link_title']?>-<?php echo $rows['iddm']?>.html" class="a-menu"><?php echo $rows['tendm']?> &rsaquo;</a>
			      </li>
				  <?php
					}
				  ?>
...
<div class="banner-sanpham">
	<?php
		if(isset($_REQUEST['id'])){
			echo "<img class='cangiua' src='admin-vm2017/public/img/anh/{$rows4['img']}' width = '320px'  alt='{$rows4['tendm']}' />";
		}else{
	?>
